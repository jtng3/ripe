...
export type Listing = {
  ...
  weightLbs: number; // drives the impact receipt
  rating: number;
  handoffs: number;
  verified: boolean;
  memberSince: string;
...
export const listings: Listing[] = [
  ...
  },
  {
    ...
    distance: "0.4 mi",
    pickupKind: "hub",
    pickupLabel: "Hub · Elm St",
    exactPickup: "Elm St Hub · the green crate by the gate",
    price: "$5",
    suggestedAmount: 5,
    payNote: "PAY WHAT'S FAIR",
    ...
    verified: true,
    memberSince: "January",
    review: "Sweetest peaches all summer. Diego's a legend.",
    handles: { venmo: "Diego-Orchard", paypal: "diegoorchard" },
  },
  {
    id: "zucchini",
    grower: "Priya",
