...
export const listings: Listing[] = [
  {
    ...
    exactPickup: "Elm St Hub · basket in the cabinet, blue door",
    price: "$3",
    suggestedAmount: 3,
  ...
  },
  {
    ...
    grower: "Marcus",
    initial: "M",
    title: "Borrow my rototiller on weekends",
    distance: "0.4 mi",
    pickupKind: "porch",
  ...
  },
  {
    ...
    grower: "Omar",
    initial: "O",
    title: "Borrow my wheelbarrow anytime",
    distance: "0.2 mi",
    pickupKind: "porch",
    pickupLabel: "Tool to borrow",
    exactPickup: "Pickup details shared once you connect",
    price: "Free to borrow",
    suggestedAmount: 0,
    payNote: "ANYTIME · RINSE & RETURN",
    image: "/commons/wheelbarrow.jpg",
    available: 1,
    weightLbs: 0,
    rating: 4.9,
    handoffs: 14,
    verified: true,
    memberSince: "2024",
    review: "Hauled a yard of mulch with it. Omar even dropped it off.",
    handles: {},
  },
  {
    id: "help-lourdes",
